...
object MyLoader {
    fun showLoader(
        ...
        if (myLoader == null && overlay == null) {
            ...
            overlayNew.setBackgroundColor(context.getColor(R.color.loader_bg))
    ...
    fun showLoader(parentLayout: ViewGroup, context: Context) {
        val myLoader = parentLayout.findViewById<LottieAnimationView>(R.id.myLoader)
        val overlay = parentLayout.findViewById<View>(R.id.overlay)
    ...
    fun showLoader(parentLayout: ViewGroup, context: Context, lottieJsonAnim: Int?) {
        val myLoader = parentLayout.findViewById<LottieAnimationView>(R.id.myLoader)
        val overlay = parentLayout.findViewById<View>(R.id.overlay)
    ...
    fun showLoader(parentLayout: ViewGroup, sizeInDp: Int?, context: Context) {
        val myLoader = parentLayout.findViewById<LottieAnimationView>(R.id.myLoader)
        val overlay = parentLayout.findViewById<View>(R.id.overlay)
    ...
    fun hideLoader(parentLayout: ViewGroup) {
        val myLoader = parentLayout.findViewById<LottieAnimationView>(R.id.myLoader)
        val overlay = parentLayout.findViewById<View>(R.id.overlay)
